<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ACCOUNT-TICKETS.aspx.cs" Inherits="NewFolder1_ACCOUNT_TICKETS" %>
...
<head runat="server">
    ...
    <link rel='stylesheet' href='account-tickets.css' />
                ...
                <div class="col-lg-4 pb-5">
                    ...
                    <div class="wizard">
                        <nav class="list-group list-group-flush">
                          <a class="list-group-item" href="SETTINGS.aspx" target="__blank"><i class="fa fa-user text-muted"></i>Profile Settings</a><a class="list-group-item" href="#"><i class="fa fa-map-marker text-muted"></i>Addresses</a>
                            <a class="list-group-item" href="WISHLIST.aspx" tagert="__blank">
